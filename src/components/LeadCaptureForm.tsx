...
export default function LeadCaptureForm({ isOpen, onClose, packageTitle, packagePrice }: LeadCaptureFormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.budget.trim()) {
      newErrors.budget = "Budget is required";
    } else if (isNaN(Number(formData.budget.replace(/,/g, "")))) {
      newErrors.budget = "Please enter a numeric value";
    }
        ...
        >
          ...
          >
            <CardHeader className="text-center relative pb-4">
              <button onClick={onClose} className="absolute right-4 top-2 text-gray-500 hover:text-black">
                <X className="w-5 h-5" />
              </button>
              <div className="flex justify-center">
                <Image src="/headerLogo.png" alt="Logo" width={60} height={60} />
              </div>
              <CardTitle className="text-lg font-bold mt-2 text-gray-800">
                Book Your Trip
              </CardTitle>
              {packageTitle && (
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div>
                    <Input
                      ...
                      value={formData.fullName}
                      onChange={(e) => handleInputChange("fullName", e.target.value)}
                      className={`${errors.fullName ? "border-red-500" : "border-gray-300"} bg-white`}
                    />
                  ...
                  <div>
                    <Input
                      ...
                      value={formData.phone}
                      onChange={(e) => handleInputChange("phone", e.target.value)}
                      className={`${errors.phone ? "border-red-500" : "border-gray-300"} bg-white`}
                    />
                  ...
                  <div>
                    <Input
                      ...
                      value={formData.destination}
                      onChange={(e) => handleInputChange("destination", e.target.value)}
                      className={`${errors.destination ? "border-red-500" : "border-gray-300"} bg-white`}
                    />
                  ...
                  <div>
                    <Input
                      ...
                      value={formData.budget}
                      onChange={(e) => handleInputChange("budget", e.target.value)}
                      className={`${errors.budget ? "border-red-500" : "border-gray-300"} bg-white`}
                    />
                  ...
                  <div>
                    <Textarea
                      ...
                      value={formData.message}
                      onChange={(e) => handleInputChange("message", e.target.value)}
                      className={`${errors.message ? "border-red-500" : "border-gray-300"} bg-white`}
                    />
                  ...
                  <Button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 font-semibold rounded-lg"
                  >
                    {isSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 mr-2 animate-spin" />
