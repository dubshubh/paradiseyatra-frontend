                    ...
                    >
                      ...
                      >
                        ...
                        <ChevronDown className={`w-4 h-4 ml-1 transition-transform duration-200 ${activeDropdown === index ? "rotate-180" : ""}`} />
                          ...
                          className="absolute left-0 top-full mt-1 w-80 bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl border border-gray-100 z-20 overflow-y-auto max-h-96 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
                        >
