    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-xl p-4 shadow-sm w-32">
            ...
            <div className="text-center mb-12 pt-10">
              ...
              <div className="mb-6">
                <div className="relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-purple-600/5 to-green-600/5 rounded-3xl"></div>
                  <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-100 p-3 md:p-4">
                    <div className="grid grid-cols-3 gap-2 md:gap-4">
                      {/* Total Results */}
                      <div className="text-center group">
                        <div className="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white mb-1.5 group-hover:scale-110 transition-transform duration-300">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                          </svg>
                        </div>
                        <div className="text-xl md:text-2xl font-bold text-gray-900 mb-0.5 group-hover:text-blue-600 transition-colors duration-300">
                          {filteredItems.length}
                        </div>
                        <div className="text-[10px] md:text-xs font-medium text-gray-600 uppercase tracking-wider">Total Results</div>
                      </div>

                      {/* Tour Packages */}
                      <div className="text-center group">
                        <div className="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-xl bg-gradient-to-br from-green-500 to-green-600 text-white mb-1.5 group-hover:scale-110 transition-transform duration-300">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                          </svg>
                        </div>
                        <div className="text-xl md:text-2xl font-bold text-gray-900 mb-0.5 group-hover:text-green-600 transition-colors duration-300">
                          {filteredItems.filter(item => item.type === "package").length}
                        </div>
                        <div className="text-[10px] md:text-xs font-medium text-gray-600 uppercase tracking-wider">Tour Packages</div>
                      </div>

                      {/* Destinations */}
                      <div className="text-center group">
                        <div className="inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 text-white mb-1.5 group-hover:scale-110 transition-transform duration-300">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                          </svg>
                        </div>
                        <div className="text-xl md:text-2xl font-bold text-gray-900 mb-0.5 group-hover:text-purple-600 transition-colors duration-300">
                          {filteredItems.filter(item => item.type === "destination").length}
                        </div>
                        <div className="text-[10px] md:text-xs font-medium text-gray-600 uppercase tracking-wider">Destinations</div>
                      </div>
                    </div>
                  </div>
                </div>
